    ...
    public abstract class Channel
    {
        ...
        public async Task SendDataAsync(byte[] data)
        {
            ...
            do
            {
                ...
                msg.Data = buf;
                await _connectionService._session.SendMessageAsync(msg);
        ...
        public void SendEof()
        {
            ...
            _connectionService._session.SendMessageAsync(msg).Wait();
        }
        ...
        public void SendClose(uint? exitCode = null)
        {
            ...
            if (exitCode.HasValue)
                _connectionService._session.SendMessageAsync(new ExitStatusMessage { RecipientChannel = ClientChannelId, ExitStatus = exitCode.Value }).Wait();
            _connectionService._session.SendMessageAsync(new ChannelCloseMessage { RecipientChannel = ClientChannelId }).Wait();
        ...
        private void ServerAttemptAdjustWindow(uint messageLength)
        {
            ...
            {
                _connectionService._session.SendMessageAsync(new ChannelWindowAdjustMessage
                {
